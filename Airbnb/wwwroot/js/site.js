...
function catCardGenerateRoomsPage()
{
    if (window.location.pathname.split("/")[1] == "Rooms")
    {
        ...
        for (i = 0; i < 6; i++)
        {
            ...
            roomReviewsUserReviewsUserInfoDetailsName.innerText = `Bob`; // DB DATA
            ...
            roomReviewsUserReviewsUserInfoDetailsTime.innerText = `1 year on Catbnb`; // DB DATA
            ...
            roomReviewsUserReviewsUserInfoRatingDetailsDateSubmitted.innerText = `Month ${2024}`; // DB DATA
            ...
            roomReviewsUserReviewsUserInfoRatingDetailsStayAmount.innerText = `Stayed forever`; // DB DATA
